...
public:
    ...
    void setSendFrameCallback(SendPacketCallback cb, void* arg1, void* arg2); // 对发送数据帧设置回调
...
private:
    static void timeoutCallback(void*);  // 时间超时回调
...
private:
    TimerEvent* mTimerEvent;    // 消费者有一个定时事件， 间隔一定时间就会向生产者取数据
